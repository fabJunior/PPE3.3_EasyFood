...
public final class InscriptionForm {
	...
	private static final String CHAMP_NUMADR     = "numAdr";
	private static final String CHAMP_NOMADR     = "nomAdr";
	private static final String CHAMP_CP         = "cpAdr";
	private static final String CHAMP_VILLE      = "villeAdr";
	...
	public Utilisateur inscrireUtilisateur( HttpServletRequest request ) {
		...
		String numAdr = getValeurChamp ( request, CHAMP_NUMADR );
		String nomAdr = getValeurChamp ( request, CHAMP_NOMADR );
		String cpAdr = getValeurChamp ( request, CHAMP_CP );
		String villeAdr = getValeurChamp ( request, CHAMP_VILLE );
		...
		try {
			...
			traiterNumAdr( numAdr, utilisateur );
			traiterNomAdr( nomAdr, utilisateur );
			traiterCp( cpAdr, utilisateur );
			traiterVille( villeAdr, utilisateur );
			traiterType( type, utilisateur );
